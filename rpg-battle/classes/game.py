...
class Person:
    ...
    def choose_action(self):
        i = 1
        print("\n" + bcolors.OKBLUE + bcolors.BOLD + self.name + " ACTIONS" + bcolors.ENDC)
    ...
    def get_enemy_stats(self):
        ...
        print(bcolors.BOLD + self.name + "  " + current_hp +  "  |" + bcolors.FAIL + hp_bar + bcolors.ENDC + bcolors.BOLD + "|" + bcolors.ENDC)
